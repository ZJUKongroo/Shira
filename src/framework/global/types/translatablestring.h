...
#ifndef TYPES_TRANSLATABLESTRING_H
#define TYPES_TRANSLATABLESTRING_H
...
struct TranslatableString::Arg : public TranslatableString::IArg
{
	...
	{
		res = std::apply([&](const Args & ...args) { return res.arg(makeQArg(arg)...); }, args);
	}
...
#endif // TYPES_TRANSLATABLESTRING_H
