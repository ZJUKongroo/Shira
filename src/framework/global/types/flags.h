...
#ifndef TYPES_FLAGS_H
#define TYPES_FLAGS_H
...
public:
	...
	constexpr inline Flag &setFlag(Enum flag, bool on = true)
	{
...
#define DECLARE_FLAGS(Name, Enum) \
	using Name = shira::Flags<Enum>;

#define DECLARE_OPERATORS_FOR_FLAGS(Name)                                        \
	constexpr inline shira::Flags<Name::enum_type> operator|(Name::enum_type f1, \
															 Name::enum_type f2) \
	{																			 \
		return shira::Flags<Name::enum_type>(f1) | f2;                           \
	}
