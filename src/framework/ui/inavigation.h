...
#ifndef UI_INAVIGATION_H
#define UI_INAVIGATION_H
...
public:
	...
	struct Index
	{
		...
		inline bool operator==(const Index &idx) { return column == idx.column && row == idx.row; }
...
public:
	...
	virtual std::set<INavigationControl *> &controls() const = 0;
